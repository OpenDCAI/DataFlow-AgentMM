---
name: create-env
description: Audit an existing environment, MCP server, application, library, or empty product idea and turn it into a lightweight DataFlow-AgentMM Env adapter, optional Task catalog, and independently replay-verifiable workflow.
---

# Create DataFlow-AgentMM Env v2
...
- Existing DataFlow-AgentMM Env: audit its actual tool dispatcher and lifecycle.
...
`dataflow_agentmm.environments` entry-point group. Include task JSON/assets in
